<template>
  <div class="flex min-h-screen">
    <!-- 左側選單欄 -->
    <div class="flex flex-col justify-between w-64 bg-violet-600 text-white">
      <div>
        <!-- Logo -->
        ...
        <ul>
          <li>
            <RouterLink to="/" class="flex items-center px-5 py-3 text-white">
              <heroicons-outline-home class="w-5 h-5 mr-2" />首頁
            </RouterLink>
          </li>
          <li>
            <RouterLink to="/" class="flex items-center px-5 py-3 text-violet-400 hover:text-white">
              <heroicons-outline-document-text class="w-5 h-5 mr-2" />文章
            </RouterLink>
          </li>
          <li>
            <RouterLink to="/" class="flex items-center px-5 py-3 text-violet-400 hover:text-white">
              <heroicons-outline-user class="w-5 h-5 mr-2" />個人資料
            </RouterLink>
          </li>
        </ul>
      </div>
